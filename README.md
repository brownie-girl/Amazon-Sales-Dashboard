...
├── Amazon_cleaned.ipynb            # Python data cleaning notebook
├── Amazon_sales_dataset_cleaned.csv # cleaned dataset
...
2. Open `Amazon_Dashboard.pbix` in Power BI Desktop
3. Explore the interactive slicers and cross-filtering visuals
